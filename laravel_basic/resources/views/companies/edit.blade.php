    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="edit-companies-form" novalidate>
                        @csrf
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input value="{{ $company['name'] }}" id="input-name" type="text" class="form-control" name="name" value="{{ old('name') }}" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input value="{{ $company['email'] }}" id="input-email" type="text" class="form-control" name="email" value="{{ old('email') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input value="{{ $company['balance'] }}" id="input-balance" type="text" class="form-control" name="balance" value="{{ old('balance') }}" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input value="{{ $company['website'] }}" id="input-website" type="text" class="form-control" name="website" value="{{ old('website') }}" autofocus>
...
<script>
    ...
    $('#button-submit').on('click', function () {
        const form_data = new FormData(document.getElementById("edit-companies-form"));
        ...
        $.ajax({
            ...
            success: function () {
                Swal.fire({
                    position: 'center',
                    icon: 'success',
                    title: 'That data have been edited !!!',
